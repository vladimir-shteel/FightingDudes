...
// Worker merge level is gated by wave: rises one tier per unlock wave up to merge.maxLevel. Keeps the
// early roster wide and paces capstones (they only fire at the true maxLevel).
